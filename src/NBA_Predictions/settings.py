...
SECRET_KEY = 'django-insecure-*)29v8&e#e!%rhwy5$w$tun-v-rr&m)%#%9*e8h0fc(uzjn7nx'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",  # Change if React runs on a different port
]

# Allow all headers and methods (for local testing)
CORS_ALLOW_HEADERS = ["*"]
CORS_ALLOW_METHODS = ["*"]
